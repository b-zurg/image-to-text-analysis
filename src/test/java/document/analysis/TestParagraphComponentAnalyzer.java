...
//			System.out.println(l.getConvertedLine());
			...
			File file1 = new File("D:\\Code\\workspace\\ImageToText-Analysis\\src\\test\\resources\\processed\\lines\\gg");
			Files.createParentDirs(file1);

			imageio.saveImage(subLines.get(i), "D:\\Code\\workspace\\ImageToText-Analysis\\src\\test\\resources\\processed\\lines", "line" + i);
	
			Lanalyzer.setLineImage(subLines.get(i));
			List<BufferedImage> subWords = Lanalyzer.getWordSubImages();
			for(int j = 0; j < subWords.size(); j++) {
				File file2 = new File("D:\\Code\\workspace\\ImageToText-Analysis\\src\\test\\resources\\processed\\words\\" + "line"+i+"\\gg");
				Files.createParentDirs(file2);
				imageio.saveImage(subWords.get(j), "D:\\Code\\workspace\\ImageToText-Analysis\\src\\test\\resources\\processed\\words\\" + "line"+i+"\\", "word" + j);
			
				Word word = new Word(subWords.get(j));
				List<BufferedImage> subLetters = word.getLetterImages();
				for(int k = 0; k < subLetters.size(); k++) {
					File file3 = new File("D:\\Code\\workspace\\ImageToText-Analysis\\src\\test\\resources\\processed\\words\\" + "line"+i+"\\", "word" + j + "\\gg");
					Files.createParentDirs(file3);
					
					imageio.saveImage(subLetters.get(k), "D:\\Code\\workspace\\ImageToText-Analysis\\src\\test\\resources\\processed\\words\\" + "line"+i+"\\", "word" + j + "\\letter" + k);
